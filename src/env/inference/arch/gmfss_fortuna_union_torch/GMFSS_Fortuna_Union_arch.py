...
class Model:
    ...
    def load_model(self, path):
        ...
        metricnet_path = "{}\\GMFSS_fortuna_union_metric.pkl".format(path)
        self.metricnet.load_state_dict(torch.load(metricnet_path))

        feat_path = "{}\\GMFSS_fortuna_union_feat.pkl".format(path)
        self.feat_ext.load_state_dict(torch.load(feat_path))

        fusionnet_path = "{}\\GMFSS_fortuna_union_fusionnet.pkl".format(path)
